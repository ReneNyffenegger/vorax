module Vorax
  ...
  class TableTagHandler < AbstractTagHandler
    ...
    def vertical(node)
      buffer = ''
      columns = []
      node.xpath("tr[1]/th").each { |col| columns << col.text.mb_chars.strip }
