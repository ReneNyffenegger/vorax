...
module Source
  ...
  class Lexer < ANTLR3::Lexer
    ...
    def id!
      ...
      # - - - - main rule block - - - -
      # at line 105:5: ( 'A' .. 'Z' ( 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' )* | DOUBLEQUOTED_STRING )
      alt_2 = 2
      ...
      case alt_2
      when 1
        # at line 105:7: 'A' .. 'Z' ( 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' )*
        match_range( 0x41, 0x5a )
        # at line 105:18: ( 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' )*
      ...
      when 2
        # at line 106:7: DOUBLEQUOTED_STRING
        doublequoted_string!
    ...
    def ml_comment!
      ...
      # - - - - main rule block - - - -
      # at line 120:4: '/*' ( options {greedy=false; } : . )* '*/'
      match( "/*" )
      # at line 120:9: ( options {greedy=false; } : . )*
    ...
    class DFA7 < ANTLR3::DFA
      EOT = unpack( 1, -1, 8, 9, 5, -1, 1, 9, 1, 25, 1, 26, 1, 27, 7, 9, 
                    3, -1, 10, 9, 1, 45, 1, 9, 1, 47, 4, 9, 1, -1, 1, 9, 
                    1, -1, 1, 53, 4, 9, 1, -1, 1, 9, 1, 59, 1, 9, 1, 61, 
                    1, 62, 1, -1, 1, 9, 2, -1, 1, 64, 1, -1 )
      EOF = unpack( 65, -1 )
      MIN = unpack( 1, 9, 2, 82, 2, 83, 1, 85, 1, 65, 1, 82, 1, 73, 5, -1, 
                    1, 69, 3, 35, 1, 78, 1, 67, 1, 79, 1, 80, 1, 73, 1, 
                    69, 1, 65, 3, -1, 1, 67, 1, 75, 1, 67, 1, 69, 1, 71, 
                    1, 87, 2, 84, 1, 65, 1, 69, 1, 35, 1, 71, 1, 35, 1, 
                    69, 1, 73, 1, 71, 1, 68, 1, -1, 1, 69, 1, -1, 1, 35, 
                    1, 79, 1, 69, 1, 85, 1, 82, 1, -1, 1, 78, 1, 35, 1, 
                    82, 2, 35, 1, -1, 1, 69, 2, -1, 1, 35, 1, -1 )
      MAX = unpack( 1, 90, 2, 82, 2, 83, 1, 85, 1, 82, 1, 89, 1, 73, 5, 
                    -1, 1, 69, 3, 95, 1, 78, 1, 67, 1, 79, 1, 80, 1, 73, 
                    1, 69, 1, 65, 3, -1, 1, 67, 1, 75, 1, 67, 1, 69, 1, 
                    71, 1, 87, 2, 84, 1, 65, 1, 69, 1, 95, 1, 71, 1, 95, 
                    1, 69, 1, 73, 1, 71, 1, 68, 1, -1, 1, 69, 1, -1, 1, 
                    95, 1, 79, 1, 69, 1, 85, 1, 82, 1, -1, 1, 78, 1, 95, 
                    1, 82, 2, 95, 1, -1, 1, 69, 2, -1, 1, 95, 1, -1 )
      ACCEPT = unpack( 9, -1, 1, 11, 1, 12, 1, 13, 1, 14, 1, 15, 11, -1, 
                       1, 2, 1, 3, 1, 4, 17, -1, 1, 8, 1, -1, 1, 10, 5, 
                       -1, 1, 1, 5, -1, 1, 6, 1, -1, 1, 9, 1, 5, 1, -1, 
                       1, 7 )
      SPECIAL = unpack( 65, -1 )
      TRANSITION = [
        unpack( 2, 10, 2, -1, 1, 10, 18, -1, 1, 10, 1, -1, 1, 9, 10, -1, 
                1, 11, 1, 13, 1, 12, 17, -1, 1, 4, 1, 9, 1, 1, 2, 9, 1, 
                5, 2, 9, 1, 3, 5, 9, 1, 2, 1, 6, 3, 9, 1, 7, 1, 9, 1, 8, 
                4, 9 ),
        unpack( 1, 14 ),
        unpack( 1, 15 ),
        unpack( 1, 16 ),
        unpack( 1, 17 ),
        unpack( 1, 18 ),
        unpack( 1, 19, 16, -1, 1, 20 ),
        unpack( 1, 22, 6, -1, 1, 21 ),
        unpack( 1, 23 ),
        unpack(  ),
        unpack(  ),
        unpack(  ),
